...
CreateThread(function()
	while true do
		...
		if objects.object ~= nil and objects.ObjectVertX ~= nil and objects.ObjectVertY ~= nil and objects.ObjectVertZ ~= nil and objects.OjbectDir ~= nil and objects.isBed ~= nil then
			...
			if using == true then
				Draw2DText("~g~Alt~w~, за да станете!",0,1,0.5,0.92,0.6,255,255,255,255)

				if IsControlJustPressed(0, 19) or IsControlJustPressed(0, 48) or IsControlJustPressed(0, 20) then
